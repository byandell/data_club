...
Likely split into two lessons, with first on setup and thinking about experiment, and second on correlation.
...
The challenge with using measures based on ranks is that we lose some power to detect relationship by making fewer assumptions.
